...
Note: When using a Workbench project, use the function composite_files_from_workbench_harmonic_analysis
...
from ansys.dpf.composites.data_sources import composite_files_from_workbench_harmonic_analysis
...
composite_files = composite_files_from_workbench_harmonic_analysis(result_folder)
