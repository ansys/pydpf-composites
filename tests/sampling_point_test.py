...
def test_sampling_point(dpf_server):
    ...
    offsets = sampling_point.get_offsets(["bottom", "top"], 1.)
    scaled_offsets = sampling_point.get_offsets(["bottom", "top"], 0.2)
    ref_offsets = [-0.00295, -0.0027, -0.0027, -0.0025, -0.0025, 0.0025, 0.0025, 0.0027, 0.0027, 0.00295]
    ref_scaled_offsets = [-0.00295, -0.0027, -0.0027, -0.0025, -0.0025, -0.0015, -0.0015, -0.0013, -0.0013, -0.00105]
    ...
    fig, axes = sampling_point.get_result_plots(strain_components=["e1", "e12"],
