...
from ..data_sources import CompositeDataSources, get_composite_data_sources_for_layup_provider
...
def add_layup_info_to_mesh(
    ...
    """
    composite_data_sources = get_composite_data_sources_for_layup_provider(
