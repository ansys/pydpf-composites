...
class LaRCCriterion(FailureCriterionBase):
    ...
    wf_lmt = property(_get_wf_lmt, _set_wf_lmt,
                      doc="Weighting factor of matrix failure due to tension (lmt).")
