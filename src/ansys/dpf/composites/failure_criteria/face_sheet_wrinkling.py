...
class FaceSheetWrinklingCriterion(FailureCriterionBase):
    ...
    wf = property(_get_wf, _set_wf,
                         doc="Weighting factor of the failure mode (wb or wt).")
    homogeneous_core_coeff = property(_get_homogeneous_core_coeff, _set_homogeneous_core_coeff,
                         doc="Wrinkling coefficient (reduction factor) for homogeneous core materials. Default is 0.5")
    honeycomb_core_coeff = property(_get_honeycomb_core_coeff, _set_honeycomb_core_coeff,
