...
class HashinCriterion(FailureCriterionBase):
    ...
    hf = property(_get_hf, _set_hf,
                         doc="Activates the failure evaluation regarding fiber failure.")
    hm = property(_get_hm, _set_hm,
                         doc="Activates the failure evaluation regarding matrix failure.")
    ...
    wf_hm = property(_get_wf_hm, _set_wf_hm,
                     doc="Weighting factor of the matrix failure (hm) mode.")
    wf_hd = property(_get_wf_hd, _set_wf_hd,
                 doc="Weighting factor of the delamination (hd) mode.")
